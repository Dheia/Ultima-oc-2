...
class BaseComponent {
  ...
  _queueCallback(callback, element, isAnimated = true) {
    if (!isAnimated) {
      Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["execute"])(callback)
      return
    }

    const transitionDuration = Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["getTransitionDurationFromElement"])(element)
    _dom_event_handler__WEBPACK_IMPORTED_MODULE_2__["default"].one(element, 'transitionend', () => Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["execute"])(callback))

    Object(_util_index__WEBPACK_IMPORTED_MODULE_1__["emulateTransitionEnd"])(element, transitionDuration)
  }
...
class Collapse extends _base_component__WEBPACK_IMPORTED_MODULE_5__["default"] {
  ...
  _getParent() {
    ...
    parent = Object(_util_index__WEBPACK_IMPORTED_MODULE_0__["getElement"])(parent)
...
class Modal extends _base_component__WEBPACK_IMPORTED_MODULE_5__["default"] {
  ...
  show(relatedTarget) {
    ...
    Object(_util_scrollbar__WEBPACK_IMPORTED_MODULE_4__["hide"])()
  ...
  _hideModal() {
    ...
    this._backdrop.hide(() => {
      document.body.classList.remove(CLASS_NAME_OPEN)
      this._resetAdjustments()
      Object(_util_scrollbar__WEBPACK_IMPORTED_MODULE_4__["reset"])()
  ...
  _triggerBackdropTransition() {
    ...
    _dom_event_handler__WEBPACK_IMPORTED_MODULE_1__["default"].one(this._element, 'transitionend', () => {
      this._element.classList.remove(CLASS_NAME_STATIC)
      if (!isModalOverflowing) {
        _dom_event_handler__WEBPACK_IMPORTED_MODULE_1__["default"].one(this._element, 'transitionend', () => {
          this._element.style.overflowY = ''
  ...
  _adjustDialog() {
    const isModalOverflowing = this._element.scrollHeight > document.documentElement.clientHeight
    const scrollbarWidth = Object(_util_scrollbar__WEBPACK_IMPORTED_MODULE_4__["getWidth"])()
    const isBodyOverflowing = scrollbarWidth > 0
...
class Backdrop {
  ...
  _emulateAnimation(callback) {
    ...
    const backdropTransitionDuration = Object(_index__WEBPACK_IMPORTED_MODULE_1__["getTransitionDurationFromElement"])(this._getElement())
    _dom_event_handler__WEBPACK_IMPORTED_MODULE_0__["default"].one(this._getElement(), 'transitionend', () => Object(_index__WEBPACK_IMPORTED_MODULE_1__["execute"])(callback))
    Object(_index__WEBPACK_IMPORTED_MODULE_1__["emulateTransitionEnd"])(this._getElement(), backdropTransitionDuration)
  }
}
...
/*!*****************************************************!*\
  !*** ./node_modules/bootstrap/js/src/util/index.js ***!
  \*****************************************************/
/*! exports provided: getElement, getUID, getSelectorFromElement, getElementFromSelector, getTransitionDurationFromElement, triggerTransitionEnd, isElement, emulateTransitionEnd, typeCheckConfig, isVisible, isDisabled, findShadowRoot, noop, reflow, getjQuery, onDOMContentLoaded, isRTL, defineJQueryPlugin, execute */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!*********************************************************!*\
  !*** ./node_modules/bootstrap/js/src/util/scrollbar.js ***!
  \*********************************************************/
/*! exports provided: getWidth, hide, isBodyOverflowing, reset */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const _setElementAttributes = (selector, styleProp, callback) => {
  const scrollbarWidth = getWidth()
  _dom_selector_engine__WEBPACK_IMPORTED_MODULE_0__["default"].find(selector)
    .forEach(element => {
      if (element !== document.body && window.innerWidth > element.clientWidth + scrollbarWidth) {
        return
      }
...
const _resetElementAttributes = (selector, styleProp) => {
  _dom_selector_engine__WEBPACK_IMPORTED_MODULE_0__["default"].find(selector).forEach(element => {
...
__webpack_require__(/*! ../../node_modules/bootstrap/js/src/modal */ "./node_modules/bootstrap/js/src/modal.js");

__webpack_require__(/*! ../../node_modules/bootstrap/js/src/collapse */ "./node_modules/bootstrap/js/src/collapse.js");

__webpack_require__(/*! @popperjs/core */ "./node_modules/@popperjs/core/lib/index.js");

var bootstrap = __webpack_require__(/*! bootstrap/dist/js/bootstrap.esm */ "./node_modules/bootstrap/dist/js/bootstrap.esm.js");
...
/* harmony default export */ __webpack_exports__["default"] = (new ( /*#__PURE__*/function () {
  ...
  _createClass(WishList, [{
    ...
    value: function init() {
      ...
      document.querySelectorAll(this.productItem).forEach(function (product) {
        var productPrice = Number(product.getAttribute('data-price-one-product')),
        ...
        _this.chechCounter(counter, decrement);
        ...
        counter.addEventListener('change', function (e) {
          ...
          _this.xhr = $.request('Cart::onUpdate', {
            data: {
              'cart': [{
                'id': position,
                'quantity': quantity
        ...
        productSum.addEventListener('change', function (e) {
          sumOutput.innerHTML = e.target.value;
        });

        _this.makeOrderForm.addEventListener('submit', function (e) {
          e.preventDefault();
          ...
          _this.xhr = $.request('MakeOrder::onCreate', {
            data: data,
            success: function success(obResponse) {
              ...
              if (!obResponse.status) {
                alert(obResponse.message); // alert('Произошла ошибка при оформлении заказа. Ваша корзина сохранена. Свяжитесь с администрацией сайта.');
              }
        ...
        deleteBtn.addEventListener('click', function (e) {
          ...
          _this.xhr = $.request('Cart::onRemove', {
            data: {
              'cart': [position],
              'type': 'position'
            },
        ...
        product.addEventListener('hidden.bs.collapse', function () {
          _self.productsContainer.removeChild(product);

          var productItemsCounter = document.querySelectorAll(_self.productItem).length;
      ...
      this.totalSum.addEventListener('change', function (e) {
        _self.totalSumOutput.innerHTML = e.target.value;
      });
    }
  }, {
    key: "chechCounter",
    value: function chechCounter(counter, decrement) {
...
/***/ 5:
/*!***************************************!*\
  !*** multi ./pages/store/wishlist.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\Ultima\themes\bizmark\pages\store\wishlist.js */"./pages/store/wishlist.js");
